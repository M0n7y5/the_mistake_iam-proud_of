...
void GUI::Init()
{
    ...
    mui::fonts::Init();
    window.AddCategory("RageBot", "B", false, true)
        .AddSubCategory(
            "General",
            [](mui::SubCategory& sub) {
                sub.AddFeatureSet(
                       ...
                       [](mui::FeatureSet& fs) -> void {
                           ...
                           fs.AddFeature("Prediction", &settings->ragebot.general.aimbot.Prediction);
                           ...
                           //                  "%d");
                           fs.AddFeature("Smooth Curve", &settings->ragebot.general.aimbot.SmoothMode,
                                         {AimbotSmooth::Linear, AimbotSmooth::SlowEnd}, {"Linear", "SlowEnd"});
                           fs.AddFeature("Smoothing", &settings->ragebot.general.aimbot.Smooth, 0, 50, "%d");
                           fs.AddFeature("FOV Circle", &settings->ragebot.general.aimbot.FOV);
                           fs.AddFeature("FOV Radius", &settings->ragebot.general.aimbot.FOVRadius, 10, 180, "%d");
                       })
                    .AddFeatureSet("Magic",
                                   [](mui::FeatureSet& fs) {
                                       ...
                                       fs.AddFeature("Smart Hit Scan", &settings->ragebot.general.magic.SmartHitscan);
                                       fs.AddFeature("Max Hitscan Points",
                                                     &settings->ragebot.general.magic.NumberOfHitscanPoints, 30, 400,
                                                     "%d");
                                   })
                    .AddFeatureSet("Projectile",
                                   [](mui::FeatureSet& fs) {
                                       fs.AddFeature("Hit Override", &settings->ragebot.general.projectile.HitOverride);
                                       ...
                                       fs.AddFeature("Bullet Teleport", &settings->ragebot.general.projectile.BulletTP);
                                       ...
                                       fs.AddFeature("Bullet Rain", &settings->ragebot.general.projectile.BulletRain);
                                   })
                    .AddFeatureSet("Targeting",
                                   [](mui::FeatureSet& fs) {
                                       fs.AddFeature("Players", &settings->ragebot.general.targeting.Players);
                                       fs.AddFeature("Player Hitbox", &settings->ragebot.general.targeting.PlayerHitbox,
                                                     {
                                                         PlayerBones::eyeTranform,
                                                         PlayerBones::neck,
                                                         PlayerBones::spine1,
                                       ...
                                       fs.AddFeature("NPC Hitbox", &settings->ragebot.general.targeting.NPCHitbox,
                                                     {
                                                         PlayerBones::eyeTranform,
                                                         PlayerBones::neck,
                                                         PlayerBones::spine1,
                                       ...
                                       fs.AddFeature("Vis Check", &settings->ragebot.general.targeting.VisCheck);
                                       fs.AddFeature("Target Lock", &settings->ragebot.general.targeting.TargetLock);
                    ...
                    .AddFeatureSet("Weapon", [](mui::FeatureSet& fs) {
                        fs.AddFeature("No Spread", &settings->ragebot.general.weapon.NoSpread);
                        fs.AddFeature("Automatic", &settings->ragebot.general.weapon.Automatic);
                        fs.AddFeature("No Sway", &settings->ragebot.general.weapon.NoSway);
                        fs.AddFeature("No Recoil", &settings->ragebot.general.weapon.NoRecoil);
                        // fs.AddFeature("Recoil Humanizer", &settings->ragebot.general.projectile.BulletRain);
                    });
            },
            true)
            ...
            sub.AddFeatureSet("General",
                              [](mui::FeatureSet& fs) {
                                  ...
                                  fs.AddFeature("Intigros testos", &settings->ragebot.antiaim.general.testInt, 0, 50,
                                                (char*)u8"%d zidcoins");
                                  fs.AddFeature("Numero uno", &settings->ragebot.antiaim.general.testInt2, -120, 300,
                                                "%d %%");
                              })
        ...
        .AddSubCategory(
            ...
            [](mui::SubCategory& sub) {
                sub.AddFeatureSet("General",
                    ...
                    .AddFeatureSet("Indicators", [](mui::FeatureSet& fs) {
                        fs.AddFeature("Enabled", &settings->visuals.general.indicators.Enabled);
                        fs.AddFeature("Radar", &settings->visuals.general.indicators.Radar);
                        fs.AddFeature("Radar Size", &settings->visuals.general.indicators.RadarSize, 50, 150, "%d %%");
                        fs.AddFeature("Radar Enemies", &settings->visuals.general.indicators.RadarEnemies);
                        fs.AddFeature("Radar Friends", &settings->visuals.general.indicators.RadarFriends);
                        fs.AddFeature("Radar Sleepers", &settings->visuals.general.indicators.RadarSleepers);
                        fs.AddFeature("Radar Wounded", &settings->visuals.general.indicators.RadarWounded);
                        fs.AddFeature("Radar NPC", &settings->visuals.general.indicators.RadarNPC);
                        fs.AddFeature("Prediction", &settings->visuals.general.indicators.Prediction);
                        fs.AddFeature("Launcher Prediction ", &settings->visuals.general.indicators.PredictionLauncher);
                        fs.AddFeature("Launcher Prediction Line",
                                      &settings->visuals.general.indicators.PredictionLauncherLine);
                        fs.AddFeature("Crosshair", &settings->visuals.general.indicators.CrossHair);
                    });
        ...
        .AddSubCategory(
            ...
            [](mui::SubCategory& sub) {
                sub.AddFeatureSet("General", [](mui::FeatureSet& fs) {
                    ...
                    fs.AddFeature("Distance", &settings->visuals.collectibles.general.Distance, 50, 300, "%d meters");
                    fs.AddFeature("AntiClutter", &settings->visuals.collectibles.general.AntiClutter);
                    fs.AddFeature("Show max", &settings->visuals.collectibles.general.MaxAnticlutterCount, 3, 10, "%d");
                });
        ...
        .AddSubCategory(
            ...
            [](mui::SubCategory& sub) {
                sub.AddFeatureSet("General", [](mui::FeatureSet& fs) {
                    ...
                    fs.AddFeature("Distance", &settings->visuals.radtown.general.Distance, 50, 300, "%d meters");
                    fs.AddFeature("AntiClutter", &settings->visuals.radtown.general.AntiClutter);
                    fs.AddFeature("Show max", &settings->visuals.radtown.general.MaxAnticlutterCount, 3, 10, "%d");
                });
                sub.AddFeatureSet("Colors", [](mui::FeatureSet& fs) {
        ...
        .AddSubCategory(
            ...
            [](mui::SubCategory& sub) {
                sub.AddFeatureSet("General", [](mui::FeatureSet& fs) {
                    ...
                    fs.AddFeature("Distance", &settings->visuals.ores.general.Distance, 50, 300, "%d meters");
                    fs.AddFeature("AntiClutter", &settings->visuals.ores.general.AntiClutter);
                    fs.AddFeature("Show max", &settings->visuals.ores.general.MaxAnticlutterCount, 3, 10, "%d");
                });
                sub.AddFeatureSet("Colors", [](mui::FeatureSet& fs) {
        ...
        .AddSubCategory("Vehicles",
                        [](mui::SubCategory& sub) {
                            sub.AddFeatureSet("General", [](mui::FeatureSet& fs) {
                                ...
                                fs.AddFeature("Heli Distance", &settings->visuals.vehicles.general.HeliDistance, 50,
                                              1500, "%d meters");
                                fs.AddFeature("Boat Distance", &settings->visuals.vehicles.general.BoatDistance, 50,
                                              300, "%d meters");
                                fs.AddFeature("Patrol Distance", &settings->visuals.vehicles.general.PatrolDistance, 50,
                                              300, "%d meters");
                                fs.AddFeature("Other Distance", &settings->visuals.vehicles.general.OtherDistance, 50,
                                              300, "%d meters");
                            });
                            sub.AddFeatureSet("Colors", [](mui::FeatureSet& fs) {
