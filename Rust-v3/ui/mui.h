...
namespace mui
{
    ...
    inline void ToggleButton(const char* str_id, bool* v)
    {
        ...
        col_bg = ImGui::GetColorU32(ImLerp((ImVec4)ImColor(0, 115, 255, 0), ImColor(0, 115, 255, 255), t));
        ...
        const char* format, ImGuiSliderFlags flags = 0)
    {
        ...
        window->DrawList->AddRectFilled(
            ImVec2(frame_bb.Min.x, frame_bb.Min.y + 6.f), ImVec2(frame_bb.Max.x, frame_bb.Max.y - 8.f), col_bg,
            style.FrameRounding);
        ...
        void Draw(ImVec2 size) override
        {
...

            {
                ...
                ImGui::GetWindowDrawList()->AddShadowCircle(
                    {min.x + (size.x / 2), min.y + (size.y / 2)}, size.x / 2.5, ImGui::GetColorU32(color), 35, {0, 0});
            }
            ...
            if (ImGui::BeginPopup(popupName.c_str(), ImGuiWindowFlags_NoMove))
            {
                ...
                ImGui::BeginGroup();
                {
                    ImGui::Text("Current");
                    ImGui::ColorButton(
                        colorButtonCurrent.c_str(), color,
                ...
                ImGui::BeginGroup();
                {
                    ...
                    if (ImGui::ColorButton(
                            colorButtonPrev.c_str(), backup_color,
                            ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(90, 20)))
                        color = backup_color;
                    ImGui::EndGroup();
                }
        ...
        void Draw()
        {
                ...
                ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse);
            {
                ...
                ImGui::BeginGroup();
                {
                    ...
                    ImGui::BeginChild(
                        "__categorySelectWindow", {static_cast<float>(categoryMenuWidthAnim) + 15, 0.f},
                        ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoBackground);
                    {
                        ...
                        { // LOGO
                            ...
                            ImGui::TextColored(ImColor(0, 115, 255, txtOpacity), txt);
                        }
            ...
            ImGui::GetForegroundDrawList()->AddShadowRect(
                searchBarGlowStart, searchBarGlowEnd, IM_COL32(0, 115, 255, static_cast<int>(searchBarGlow)), 50, {},
