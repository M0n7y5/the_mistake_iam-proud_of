...
namespace mui
{
    ...
    inline void ToggleButton(const char* str_id, bool* v)
    {
        ...
        //     col_bg = ImGui::GetColorU32(ImLerp(colors[ImGuiCol_FrameBg],
        //     colors[ImGuiCol_FrameBg], t));
        // else
    ...
    */
    ...
    class FeatureSet
    {
      ...
      public:
        ...
        FeatureSet& AddFeature(std::string name, TCO* variable)
        {
            const auto f = new ColorFeature(std::move(name), &variable->Color, &variable->Enable);
            _features.emplace_back(f);
            return *this;
        }
