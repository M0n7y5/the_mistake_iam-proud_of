...
#define LAZY_IMPORTER_KHASH(str)                                                                                    \
    ::li::detail::khash(                                                                                            \
        ...
        ::li::detail::khash_impl(                                                                                   \
            __TIME__ __DATE__ LAZY_IMPORTER_STRINGIZE_EXPAND(__LINE__) LAZY_IMPORTER_STRINGIZE_EXPAND(__COUNTER__), \
            2166136261))
          ...
          public:
            ...
            LAZY_IMPORTER_FORCEINLINE const char* address(size_type index) const noexcept
            {
                ...
                const auto* const ord_table =
                    reinterpret_cast<const unsigned short*>(_base + _ied->AddressOfNameOrdinals);
