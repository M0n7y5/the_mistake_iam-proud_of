 ...
 */
template <typename T>
inline constexpr typename std::underlying_type<T>::type enumc_to_int(T t)
{
...
#define SCOPED_ENUM_FLAG2(lhs_t, ths_t)                                   \
    ...
    inline constexpr lhs_t operator|(lhs_t lhs, ths_t rhs) noexcept       \
    {                                                                     \
...
#define SCOPED_ENUM_FLAG1(enum_t)                            \
    ...
    inline constexpr enum_t operator~(enum_t value) noexcept \
    {                                                        \
        return static_cast<enum_t>(~enumc_to_int(value));    \
    }                                                        \
                                                             \
    /*  \brief Negation operator. */                         \
    inline constexpr bool operator!(enum_t value) noexcept   \
    {                                                        \
...
#define SCOPED_ENUM_FLAG(...) \
    SCOPED_ENUM_ID(GET_SCOPED_ENUM_FLAG(__VA_ARGS__, SCOPED_ENUM_FLAG2, SCOPED_ENUM_FLAG1)(__VA_ARGS__))