...
namespace jm
{
    ...
    namespace detail
    {
        ...
        XORSTR_FORCEINLINE constexpr std::uint64_t load_xored_str8(std::uint64_t key,
                                                                   std::size_t   idx,
                     ...
                     std::index_sequence<Indices...>>
    {
      ...
      public:
        ...
        {
            // everything is inlined by hand because a certain compiler with a certain linker is
            // _very_ slow
