...
namespace
{
    __attribute__((target("avx2"))) bool _Use_avx2() noexcept
    {
        return true;
    }

    __attribute__((target("default"))) bool _Use_avx2() noexcept
    {
        return false;
    }

    __attribute__((target("sse4.2"))) bool _Use_sse42() noexcept
    {
        return true;
    }
    __attribute__((target("default"))) bool _Use_sse42() noexcept
    {
        return false;
    }
...
namespace
{
    template <class _BidIt> void _Reverse_tail(_BidIt _First, _BidIt _Last) noexcept
    {
...
#error Unsupported architecture
    ...
    // TRANSITION, ABI: __std_swap_ranges_trivially_swappable() is preserved for binary
    // compatibility
                                                        ...
                                                        void* _First2) noexcept
    {
        ...
        return static_cast<char*>(_First2) +
               (static_cast<char*>(_Last1) - static_cast<char*>(_First1));
    }

    __declspec(noalias) void __cdecl __std_reverse_trivially_swappable_1(void* _First,
                                                                         void* _Last) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 64 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Right_perm =
                    _mm256_permute4x64_epi64(_Right, _MM_SHUFFLE(1, 0, 3, 2));
                // transpose all the chars in the lanes
                const __m256i _Left_reversed =
                    _mm256_shuffle_epi8(_Left_perm, _Reverse_char_lanes_avx);
                const __m256i _Right_reversed =
                    _mm256_shuffle_epi8(_Right_perm, _Reverse_char_lanes_avx);
        ...
        {
            const __m128i _Reverse_char_sse =
    ...
    __declspec(noalias) void __cdecl __std_reverse_trivially_swappable_2(void* _First,
                                                                         void* _Last) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 64 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Right_perm =
                    _mm256_permute4x64_epi64(_Right, _MM_SHUFFLE(1, 0, 3, 2));
                const __m256i _Left_reversed =
                    _mm256_shuffle_epi8(_Left_perm, _Reverse_short_lanes_avx);
                const __m256i _Right_reversed =
                    _mm256_shuffle_epi8(_Right_perm, _Reverse_short_lanes_avx);
                _mm256_storeu_si256(static_cast<__m256i*>(_First), _Right_reversed);
                _mm256_storeu_si256(static_cast<__m256i*>(_Last), _Left_reversed);
                _Advance_bytes(_First, 32);
            } while (_First != _Stop_at);
        ...
        if (_Byte_length(_First, _Last) >= 32 && _Use_sse42())
        {
            const __m128i _Reverse_short_sse =
    ...
    __declspec(noalias) void __cdecl __std_reverse_trivially_swappable_4(void* _First,
                                                                         void* _Last) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 64 && _Use_avx2())
    ...
    __declspec(noalias) void __cdecl __std_reverse_trivially_swappable_8(void* _First,
                                                                         void* _Last) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 64 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Right = _mm256_loadu_si256(static_cast<__m256i*>(_Last));
                const __m256i _Left_reversed =
                    _mm256_permute4x64_epi64(_Left, _MM_SHUFFLE(0, 1, 2, 3));
                const __m256i _Right_reversed =
                    _mm256_permute4x64_epi64(_Right, _MM_SHUFFLE(0, 1, 2, 3));
                _mm256_storeu_si256(static_cast<__m256i*>(_First), _Right_reversed);
                _mm256_storeu_si256(static_cast<__m256i*>(_Last), _Left_reversed);
                _Advance_bytes(_First, 32);
            } while (_First != _Stop_at);
        ...
        _Reverse_tail(static_cast<unsigned long long*>(_First),
                      static_cast<unsigned long long*>(_Last));
    }

    __declspec(noalias) void __cdecl __std_reverse_copy_trivially_copyable_1(const void* _First,
                                                                             const void* _Last,
                                                                             void* _Dest) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 32 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Block_permuted =
                    _mm256_permute4x64_epi64(_Block, _MM_SHUFFLE(1, 0, 3, 2));
                const __m256i _Block_reversed =
                    _mm256_shuffle_epi8(_Block_permuted, _Reverse_char_lanes_avx);
        ...
        if (_Byte_length(_First, _Last) >= 16 && _Use_sse42())
        {
            ...
            do
            {
                ...
                const __m128i _Block_reversed =
                    _mm_shuffle_epi8(_Block, _Reverse_char_sse); // SSSE3
        ...
        _Reverse_copy_tail(static_cast<const unsigned char*>(_First),
                           static_cast<const unsigned char*>(_Last),
                           static_cast<unsigned char*>(_Dest));
    }

    __declspec(noalias) void __cdecl __std_reverse_copy_trivially_copyable_2(const void* _First,
                                                                             const void* _Last,
                                                                             void* _Dest) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 32 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Block_permuted =
                    _mm256_permute4x64_epi64(_Block, _MM_SHUFFLE(1, 0, 3, 2));
                const __m256i _Block_reversed =
                    _mm256_shuffle_epi8(_Block_permuted, _Reverse_short_lanes_avx);
                _mm256_storeu_si256(static_cast<__m256i*>(_Dest), _Block_reversed);
                _Advance_bytes(_Dest, 32);
            } while (_Dest != _Stop_at);
        ...
        if (_Byte_length(_First, _Last) >= 16 && _Use_sse42())
        {
            ...
            do
            {
                ...
                const __m128i _Block = _mm_loadu_si128(static_cast<const __m128i*>(_Last));
                const __m128i _Block_reversed =
                    _mm_shuffle_epi8(_Block, _Reverse_short_sse); // SSSE3
                _mm_storeu_si128(static_cast<__m128i*>(_Dest), _Block_reversed);
                _Advance_bytes(_Dest, 16);
            } while (_Dest != _Stop_at);
        }
        ...
        _Reverse_copy_tail(static_cast<const unsigned short*>(_First),
                           static_cast<const unsigned short*>(_Last),
                           static_cast<unsigned short*>(_Dest));
    }

    __declspec(noalias) void __cdecl __std_reverse_copy_trivially_copyable_4(const void* _First,
                                                                             const void* _Last,
                                                                             void* _Dest) noexcept
    {
#ifndef _M_ARM64EC
        ...
        _Reverse_copy_tail(static_cast<const unsigned long*>(_First),
                           static_cast<const unsigned long*>(_Last),
                           static_cast<unsigned long*>(_Dest));
    }

    __declspec(noalias) void __cdecl __std_reverse_copy_trivially_copyable_8(const void* _First,
                                                                             const void* _Last,
                                                                             void* _Dest) noexcept
    {
#ifndef _M_ARM64EC
        if (_Byte_length(_First, _Last) >= 32 && _Use_avx2())
        {
            ...
            do
            {
                ...
                const __m256i _Block = _mm256_loadu_si256(static_cast<const __m256i*>(_Last));
                const __m256i _Block_reversed =
                    _mm256_permute4x64_epi64(_Block, _MM_SHUFFLE(0, 1, 2, 3));
                _mm256_storeu_si256(static_cast<__m256i*>(_Dest), _Block_reversed);
                _Advance_bytes(_Dest, 32);
            } while (_Dest != _Stop_at);
        ...
        _Reverse_copy_tail(static_cast<const unsigned long long*>(_First),
                           static_cast<const unsigned long long*>(_Last),
...
{
    template <class _Ty>
    const void* _Min_tail(const void* const _First, const void* const _Last, const void* _Res,
                          _Ty _Cur) noexcept
    {
    ...
    template <class _Ty>
    const void* _Max_tail(const void* const _First, const void* const _Last, const void* _Res,
                          _Ty _Cur) noexcept
    {
        for (auto _Ptr = static_cast<const _Ty*>(_First); _Ptr != _Last; ++_Ptr)
        {
    ...
    template <class _Ty>
    _Min_max_element_t _Both_tail(const void* const _First, const void* const _Last,
                                  _Min_max_element_t& _Res, _Ty _Cur_min, _Ty _Cur_max) noexcept
    {
        for (auto _Ptr = static_cast<const _Ty*>(_First); _Ptr != _Last; ++_Ptr)
        {
            if (*_Ptr < _Cur_min)
            ...
            // Not else!
            // * Needed for correctness if start with maximum, as we don't handle specially the
            // first element.
    ...
    auto _Minmax_tail(const void* _First, const void* _Last, _Min_max_element_t& _Res, bool _Sign,
                      _UTy _Cur_min, _UTy _Cur_max) noexcept
    {
        ...
        if constexpr (_Mode == _Mode_min)
        {
            ...
            {
                return _Min_tail(_First, _Last, _Res._Min,
                                 static_cast<_UTy>(_Cur_min + _Correction));
            }
        }
        else if constexpr (_Mode == _Mode_max)
        {
            ...
            {
                return _Max_tail(_First, _Last, _Res._Max,
        ...
        else
        {
            if (_Sign)
            {
                return _Both_tail(_First, _Last, _Res, static_cast<_STy>(_Cur_min),
                                  static_cast<_STy>(_Cur_max));
            }
            else
            {
    ...
    struct _Minmax_traits_1
    {
        ...
        static __m128i _Sign_correction(const __m128i _Val, const bool _Sign) noexcept
        {
            alignas(16) static constexpr _Unsigned_t _Sign_corrections[2][16] = {
                ...
                {}};
            return _mm_sub_epi8(
                _Val, _mm_load_si128(reinterpret_cast<const __m128i*>(_Sign_corrections[_Sign])));
        }
        ...
        template <class _Fn> static __m128i _H_func(const __m128i _Cur, _Fn _Funct) noexcept
        {
            const __m128i _Shuf_bytes =
                _mm_set_epi8(14, 15, 12, 13, 10, 11, 8, 9, 6, 7, 4, 5, 2, 3, 0, 1);
            const __m128i _Shuf_words =
        ...
        {
            return _H_func(_Cur, [](__m128i _First, __m128i _Second) {
        ...
        static _Unsigned_t _Get_v_pos(const __m128i _Idx, const unsigned long _H_pos) noexcept
        {
            return static_cast<_Unsigned_t>(
                _mm_cvtsi128_si32(_mm_shuffle_epi8(_Idx, _mm_cvtsi32_si128(_H_pos))));
        }
    ...
    struct _Minmax_traits_2
    {
        ...
        static _Unsigned_t _Get_v_pos(const __m128i _Idx, const unsigned long _H_pos) noexcept
        {
            static constexpr _Unsigned_t _Shuf[] = {0x0100, 0x0302, 0x0504, 0x0706,
    ...
    struct _Minmax_traits_8
    {
        ...
        static _Signed_t _Get_any(const __m128i _Cur) noexcept
        {
            ...
            return static_cast<_Signed_t>(
                (static_cast<_Unsigned_t>(static_cast<uint32_t>(_mm_extract_epi32(_Cur, 1)))
                 << 32) |
        ...
        static __m128i _Min(const __m128i _First, const __m128i _Second,
                            const __m128i _Mask) noexcept
        {
            return _mm_blendv_epi8(_First, _Second, _Mask);
        }

        static __m128i _Max(const __m128i _First, const __m128i _Second,
                            const __m128i _Mask) noexcept
        {
            return _mm_blendv_epi8(_First, _Second, _Mask);
        }
    ...
    auto __stdcall _Minmax_element(const void* _First, const void* const _Last,
                                   const bool _Sign) noexcept
    {
        ...
        if (_Byte_length(_First, _Last) >= 16 && _Use_sse42())
        {
            ...
            __m128i _Cur_vals = _Traits::_Sign_correction(
                _mm_loadu_si128(reinterpret_cast<const __m128i*>(_First)), _Sign);
            ...
            for (;;)
            {
                ...
                // Increment vertical indices. Will stop at exactly wrap around, if not reach the
                // end before
                ...
                if (_First == _Stop_at)
                {
                    ...
                    // Compute horizontal min and/or max. Determine horizontal and vertical position
                    // of it.

                    if constexpr ((_Mode & _Mode_min) != 0)
                    {
                        const __m128i _H_min = _Traits::_H_min(
                            _Cur_vals_min); // Vector populated by the smallest element
                        ...
                        { // Current horizontal min is less than the old
                            ...
                            const __m128i _Eq_mask = _Traits::_Cmp_eq(
                                _H_min, _Cur_vals_min); // Mask of all elems eq to min
                            ...
                            const __m128i _Idx_min_val =
                                _mm_blendv_epi8(_All_max, _Cur_idx_min, _Eq_mask);
                            __m128i _Idx_min =
                                _Traits::_H_min_u(_Idx_min_val); // The smallest indices
                            ...
                            _BitScanForward(&_H_pos,
                                            _Mask); // lgtm [cpp/conditionallyuninitializedvariable]

                            const auto _V_pos = _Traits::_Get_v_pos(
                                _Cur_idx_min, _H_pos); // Extract its vertical index
                            _Res._Min = _Base + static_cast<size_t>(_V_pos) * 16 +
                                        _H_pos; // Finally, compute the pointer
                        }
                    }

                    if constexpr ((_Mode & _Mode_max) != 0)
                    {
                        const __m128i _H_max = _Traits::_H_max(
                            _Cur_vals_max); // Vector populated by the largest element
                        ...
                        {
                            // max_element: current horizontal max is greater than the old, update
                            // max minmax_element: current horizontal max is not less than the old,
                            // update max
                            _Cur_max_val           = _H_max_val;
                            const __m128i _Eq_mask = _Traits::_Cmp_eq(
                                _H_max, _Cur_vals_max); // Mask of all elems eq to max
                            int _Mask = _mm_movemask_epi8(_Eq_mask);
                            ...
                            if constexpr (_Mode == _Mode_both)
                            {
                                ...
                                const __m128i _Idx_max =
                                    _Traits::_H_max_u(_Idx_max_val); // The greatest indices
                                // Select the greatest vertical indices from the largest element
                                // mask
                                _Mask &=
                                    _mm_movemask_epi8(_Traits::_Cmp_eq(_Idx_max, _Idx_max_val));
                            ...
                            else
                            {
                                ...
                                const __m128i _All_max = _mm_set1_epi8(static_cast<char>(0xFF));
                                const __m128i _Idx_max_val =
                                    _mm_blendv_epi8(_All_max, _Cur_idx_max, _Eq_mask);
                                const __m128i _Idx_max =
                                    _Traits::_H_min_u(_Idx_max_val); // The smallest indices
                                // Select the smallest vertical indices from the largest element
                                // mask
                                _Mask &=
                                    _mm_movemask_epi8(_Traits::_Cmp_eq(_Idx_max, _Idx_max_val));
                            ...
                            const auto _V_pos = _Traits::_Get_v_pos(
                                _Cur_idx_max, _H_pos); // Extract its vertical index
                            _Res._Max = _Base + static_cast<size_t>(_V_pos) * 16 +
                                        _H_pos; // Finally, compute the pointer
                        }
                    }
                    // Horizontal part done, results are saved, now need to see if there is another
                    // portion to process
                    ...
                    if constexpr (_Traits::_Has_portion_max)
                    {
                        ...
                        // Start next portion to handle the wrapping indices. Assume _Cur_idx is
                        // zero
                        constexpr size_t _Max_portion_byte_size = _Traits::_Portion_max * 16;
                        if (_Portion_byte_size > _Max_portion_byte_size)
                        {
                        ...
                        // Load values and if unsigned adjust them to be signed (for signed vector
                        // comparisons)
                        _Cur_vals = _Traits::_Sign_correction(
                            _mm_loadu_si128(reinterpret_cast<const __m128i*>(_First)), _Sign);
                ...
                if constexpr ((_Mode & _Mode_min) != 0)
                {
                    ...
                    const __m128i _Is_less =
                        _Traits::_Cmp_gt(_Cur_vals_min, _Cur_vals); // _Cur_vals < _Cur_vals_min
                    _Cur_idx_min  = _mm_blendv_epi8(_Cur_idx_min, _Cur_idx,
                                                    _Is_less); // Remember their vertical indices
                    _Cur_vals_min = _Traits::_Min(_Cur_vals_min, _Cur_vals,
                                                  _Is_less); // Update the current minimum
                }
                ...
                if constexpr (_Mode == _Mode_max)
                {
                    ...
                    // occurrences
                    const __m128i _Is_greater =
                        _Traits::_Cmp_gt(_Cur_vals, _Cur_vals_max); // _Cur_vals > _Cur_vals_max
                    _Cur_idx_max  = _mm_blendv_epi8(_Cur_idx_max, _Cur_idx,
                                                    _Is_greater); // Remember their vertical indices
                    _Cur_vals_max = _Traits::_Max(_Cur_vals_max, _Cur_vals,
                                                  _Is_greater); // Update the current maximum
                }
                else if constexpr (_Mode == _Mode_both)
                {
                    ...
                    _Cur_idx_max  = _mm_blendv_epi8(_Cur_idx, _Cur_idx_max,
                                                    _Is_less); // Remember their vertical indices
                    _Cur_vals_max = _Traits::_Max(_Cur_vals, _Cur_vals_max,
                                                  _Is_less); // Update the current maximum
                }
            }
        }
#endif // !_M_ARM64EC
...
extern "C"
{
    ...
    const void* __stdcall __std_min_element_1(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_min, _Minmax_traits_1>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_min_element_2(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_min, _Minmax_traits_2>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_min_element_4(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_min, _Minmax_traits_4>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_min_element_8(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_min, _Minmax_traits_8>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_max_element_1(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_max, _Minmax_traits_1>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_max_element_2(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_max, _Minmax_traits_2>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_max_element_4(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_max, _Minmax_traits_4>(_First, _Last, _Signed);
    }

    const void* __stdcall __std_max_element_8(const void* const _First, const void* const _Last,
                                              const bool _Signed) noexcept
    {
        return _Minmax_element<_Mode_max, _Minmax_traits_8>(_First, _Last, _Signed);
    }

    _Min_max_element_t __stdcall __std_minmax_element_1(const void* const _First,
    ...
    _Min_max_element_t __stdcall __std_minmax_element_2(const void* const _First,
                                                        const void* const _Last,
                                                        const bool        _Signed) noexcept
    {
    ...
    _Min_max_element_t __stdcall __std_minmax_element_4(const void* const _First,
                                                        const void* const _Last,
                                                        const bool        _Signed) noexcept
    {
    ...
    _Min_max_element_t __stdcall __std_minmax_element_8(const void* const _First,
                                                        const void* const _Last,
                                                        const bool        _Signed) noexcept
    {
...
namespace
{
    template <class _Ty> const void* _Find_trivial_unsized_fallback(const void* _First, _Ty _Val)
    {
    ...
    __declspec(noalias) size_t
        _Count_trivial_tail(const void* _First, const void* _Last, size_t _Current, _Ty _Val)
    {
        auto _Ptr = static_cast<const _Ty*>(_First);
        for (; _Ptr != _Last; ++_Ptr)
        {
    ...
    // The below functions have exactly the same signature as the extern "C" functions, up to
    // calling convention. This makes sure the template specialization is fused with the extern "C"
    // function. In optimized builds it avoids an extra call, as this function is too large to
    // inline.
    ...
    const void* __stdcall __std_find_trivial_unsized(const void* _First, const _Ty _Val) noexcept
    {
        ...
        if (_Use_avx2())
        {
            ...
            unsigned int _Bingo = static_cast<unsigned int>(
                _mm256_movemask_epi8(_Traits::_Cmp_avx(_Data, _Comparand)));
            ...
            for (;;)
            {
                ...
                _Bingo = static_cast<unsigned int>(
                    _mm256_movemask_epi8(_Traits::_Cmp_avx(_Data, _Comparand)));
        ...
        if (_Traits::_Sse_available())
        {
            ...
            unsigned int _Bingo =
                static_cast<unsigned int>(_mm_movemask_epi8(_Traits::_Cmp_sse(_Data, _Comparand)));
            ...
            for (;;)
            {
                ...
                _Bingo = static_cast<unsigned int>(
                    _mm_movemask_epi8(_Traits::_Cmp_sse(_Data, _Comparand)));

                if (_Bingo != 0)
                {
                    unsigned long _Offset;
                    _BitScanForward(&_Offset,
                                    _Bingo); // lgtm [cpp/conditionallyuninitializedvariable]
                    _Advance_bytes(_First, _Offset);
                    return _First;
                }
    ...
    template <class _Traits, class _Ty>
    const void* __stdcall __std_find_trivial(const void* _First, const void* _Last,
                                             _Ty _Val) noexcept
    {
#ifndef _M_ARM64EC
    ...
    template <class _Traits, class _Ty>
    __declspec(noalias) size_t
        __stdcall __std_count_trivial(const void* _First, const void* const _Last,
...
extern "C"
{
    const void* __stdcall __std_find_trivial_unsized_1(const void* const _First,
                                                       const uint8_t     _Val) noexcept
    {
        return __std_find_trivial_unsized<_Find_traits_1>(_First, _Val);
    }

    const void* __stdcall __std_find_trivial_unsized_2(const void* const _First,
                                                       const uint16_t    _Val) noexcept
    {
        return __std_find_trivial_unsized<_Find_traits_2>(_First, _Val);
    }

    const void* __stdcall __std_find_trivial_unsized_4(const void* const _First,
                                                       const uint32_t    _Val) noexcept
    {
        return __std_find_trivial_unsized<_Find_traits_4>(_First, _Val);
    }

    const void* __stdcall __std_find_trivial_unsized_8(const void* const _First,
                                                       const uint64_t    _Val) noexcept
    {
        return __std_find_trivial_unsized<_Find_traits_8>(_First, _Val);
    }

    const void* __stdcall __std_find_trivial_1(const void* const _First, const void* const _Last,
                                               const uint8_t _Val) noexcept
    {
        return __std_find_trivial<_Find_traits_1>(_First, _Last, _Val);
    }

    const void* __stdcall __std_find_trivial_2(const void* const _First, const void* const _Last,
                                               const uint16_t _Val) noexcept
    {
        return __std_find_trivial<_Find_traits_2>(_First, _Last, _Val);
    }

    const void* __stdcall __std_find_trivial_4(const void* const _First, const void* const _Last,
                                               const uint32_t _Val) noexcept
    {
        return __std_find_trivial<_Find_traits_4>(_First, _Last, _Val);
    }

    const void* __stdcall __std_find_trivial_8(const void* const _First, const void* const _Last,
                                               const uint64_t _Val) noexcept
    {
    ...
    __declspec(noalias) size_t
        __stdcall __std_count_trivial_1(const void* const _First, const void* const _Last,
                                        const uint8_t _Val) noexcept
    {
    ...
    __declspec(noalias) size_t
        __stdcall __std_count_trivial_2(const void* const _First, const void* const _Last,
                                        const uint16_t _Val) noexcept
    {
    ...
    __declspec(noalias) size_t
        __stdcall __std_count_trivial_4(const void* const _First, const void* const _Last,
                                        const uint32_t _Val) noexcept
    {
    ...
    __declspec(noalias) size_t
        __stdcall __std_count_trivial_8(const void* const _First, const void* const _Last,
                                        const uint64_t _Val) noexcept
    {
