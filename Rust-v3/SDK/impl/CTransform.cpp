...
{
    static auto addr =
        OFF(Offsets::UnityEngine_Transform::Methods::set_position_UnityEngine_Vector3_value);
...
{
    static auto addr =
        OFF(Offsets::UnityEngine_Transform::Methods::set_rotation_UnityEngine_Quaternion_value);
...
{
    static auto addr =
        OFF(Offsets::UnityEngine_Transform::Methods::TransformPoint_UnityEngine_Vector3_position);
...
{
    static auto addr = OFF(Offsets::UnityEngine_Transform::Methods::
                               InverseTransformPoint_UnityEngine_Vector3_position);
    return ((Vector3(__thiscall*)(CTransform*, Vector3))(addr))(this, vec);
}
